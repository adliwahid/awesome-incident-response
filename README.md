...
* [OTRS](https://www.otrs.com/otrs-free-help-desk/) - Open Technology Real Services (OTRS) is web based ticketing system known to be used by CERTs/CSIRTs for managing incidents that are reported to them. Some useful features for security response teams include support for PGP, reporting or stats generation, templates, easy artifacts management and many more  
